...
#    for v in ('e1', 'e2', 'e3', 'e4', 'e5', 'e6', 'e7', 'e8', 'e9', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8', 'n9', 'n10', 'n11'):
 #       g.addVertex(Vertexx(v))
    ...
    return g
"""""
    g.addArist(Arist(g.getVertex('e1',30,90), g.getVertex('n1',70,90)))
    g.addArist(Arist(g.getVertex('n1',70,90), g.getVertex('n2',120,100)))
    g.addArist(Arist(g.getVertex('n1',70,90), g.getVertex('n7',70,150)))
    g.addArist(Arist(g.getVertex('e2',140,30), g.getVertex('n2',120,100)))
    g.addArist(Arist(g.getVertex('e9',30,190), g.getVertex('n7',70,160)))
    g.addArist(Arist(g.getVertex('n7',70,160), g.getVertex('n8',150,150)))
    g.addArist(Arist(g.getVertex('e8',130,200), g.getVertex('n8',150,150)))
    g.addArist(Arist(g.getVertex('n8',150,150), g.getVertex('n5',160,110)))
    g.addArist(Arist(g.getVertex('n2',120,100), g.getVertex('n5',160,110)))
    g.addArist(Arist(g.getVertex('n5',160,110), g.getVertex('n6',220,110)))
    g.addArist(Arist(g.getVertex('n2',120,100), g.getVertex('n3',220,60)))
    g.addArist(Arist(g.getVertex('e3',220,30), g.getVertex('n3',220,60)))
    g.addArist(Arist(g.getVertex('n3',220,60), g.getVertex('n4',280,60)))
    g.addArist(Arist(g.getVertex('e4',280,60), g.getVertex('n4',280,60)))
    g.addArist(Arist(g.getVertex('n4',280,60), g.getVertex('e5',310,60)))
    g.addArist(Arist(g.getVertex('n6',220,100), g.getVertex('n3',220,60)))
    g.addArist(Arist(g.getVertex('n6',220,100), g.getVertex('n4',280,70)))
    g.addArist(Arist(g.getVertex('n11',290,100), g.getVertex('n10',280,150)))
    g.addArist(Arist(g.getVertex('n8',150,150), g.getVertex('n9',220,150)))
    g.addArist(Arist(g.getVertex('n9',220,150), g.getVertex('e7',220,200)))
    g.addArist(Arist(g.getVertex('n9',220,150), g.getVertex('n10',280,150)))
    g.addArist(Arist(g.getVertex('n10',280,150), g.getVertex('e6',300,200)))
    g.addArist(Arist(g.getVertex('n6',220,100), g.getVertex('n11',290,100)))
